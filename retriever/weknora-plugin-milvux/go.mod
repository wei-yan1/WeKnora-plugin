module example.com/weknora-plugin-milvux
...
// etcd v3.5.5 (an indirect dep of the Milvus client) still references the
// removed otelgrpc.UnaryServerInterceptor / StreamServerInterceptor; pin to the
// last version that exports them. Mirrors the host go.mod.
